...
const layout = require('dagre').layout
...
function render () {
  ...
  let createClusters = require('./create-clusters')
  let createEdgeLabels = require('./create-edge-labels')
  let createEdgePaths = require('./create-edge-paths')
  let positionNodes = require('./position-nodes')
  let positionEdgeLabels = require('./position-edge-labels')
  let positionClusters = require('./position-clusters')
